...
\label{sec:org57089f8}

\begin{frame}[label={sec:orge49eb98}]{Frame 1}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org0a160b9}]{Frame 2 (where we will not use columns)}
\begin{block}{Request}
