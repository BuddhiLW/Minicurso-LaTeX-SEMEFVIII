...
\begin{minted}[fontsize=\scriptsize,autogobble=true,frame=lines,framesep=1mm,linenos=false]{elisp}
...
\begin{frame}[label={sec:orgb4afa03},fragile]{Roupagem moderna, \LaTeX{} - Leslie Lamport (1985)}
 \begin{columns}
\begin{column}{0.48\columnwidth}
...
\begin{frame}[label={sec:orge3a4526},fragile]{Enumerate}
 \begin{columns}
\begin{column}{0.48\columnwidth}
\begin{block}<1->{Como renderiza:}
\begin{enumerate}
...
\subsection{Tabelas}
\label{sec:orgcd9b964}
\begin{frame}[label={sec:org21304ae},fragile]{Tabela Simples}
...
\begin{frame}[label={sec:orgb58eb54},fragile]{Os pacotes pertinentes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org01e9e8e},fragile]{Corpo do documento}
...
\label{sec:org9f2ddbc}
\begin{frame}[label={sec:orge6c9819},fragile]{Python com \texttt{pygments}, usando \texttt{minted}}
 \begin{block}{Como renderiza}
\begin{minted}[fontsize=\scriptsize,autogobble=true,frame=lines,framesep=1mm,linenos=false]{python}
import numpy as np
\end{minted}
...
\label{sec:org50bea36}
\begin{frame}[label={sec:org46f2b32}]{Documentação e modelos}
\begin{itemize}
\item \alert{Gerais:}
\begin{itemize}
